...
Client-ready brief paragraph:
${safeText(lead.briefParagraph)}
...
export const formatAssistantBriefHtml = ({ lead = {}, draft = {}, brief = {} }) => {
  ...
  const safeBriefParagraph = escapeHtml(safeText(lead.briefParagraph)).replaceAll("\n", "<br />");
            ...
            <tr>
              <td style="padding:18px 32px 8px;background:#ffffff;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:separate;border-spacing:0 14px;">
                  ...
                  <tr>
                    <td style="padding:18px;border:1px solid #d9e4e8;border-radius:8px;background:#f6fafb;">
                      <p style="margin:0 0 8px;color:#607684;font-size:12px;font-weight:700;text-transform:uppercase;">Client-ready brief paragraph</p>
                      <p style="margin:0;color:#10202a;font-size:16px;line-height:1.75;">${safeBriefParagraph}</p>
                    </td>
                  </tr>
                </table>
              </td>
